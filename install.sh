...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_arm64")
		URL="https://github.com/cxjava/wireproxy/releases/download/v1.0.0/wireproxy_darwin_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_amd64")
		URL="https://github.com/cxjava/wireproxy/releases/download/v1.0.0/wireproxy_darwin_x86_64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm64")
		URL="https://github.com/cxjava/wireproxy/releases/download/v1.0.0/wireproxy_linux_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/cxjava/wireproxy/releases/download/v1.0.0/wireproxy_linux_x86_64.tar.gz"
		FTYPE=".tar.gz"
		;;
	*) fail "No asset for platform ${OS}-${ARCH}";;
	...
	if [[ $FTYPE = ".gz" ]]; then
		...
		bash -c "$GET $URL" > "wireproxy_${OS}_${ARCH}" || fail "download failed"
	else
